...
onready var CursorMarker = load("res://CursorMarker.tscn")
...
func _ready():
	...
	#$Fade/AnimationPlayer.connect("animation_finished", self, "_on_AnimationPlayer_animation_finished")
...
func fade_to_scene(scene: PackedScene):
	...
	# TODO: Fix this botches solution.
	# Couldn't get signals to work
	var timer = get_tree().create_timer(1)
	timer.connect("timeout", self, "_on_AnimationPlayer_animation_finished")
